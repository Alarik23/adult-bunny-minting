...
import { ButtonWrap, CTAButton, MultiMintButton } from "./MultiMintButton";
...
const ImageWrap = styled.div`
  ...
  width: 500px;
  max-width: 80vw;
  background-image: url(https://media.discordapp.net/attachments/979161979065348136/1059153746120163399/s1.jpg?width=1024&height=1024);
...
const MintBtn = (props: HomeProps) => {
    ...
    const { guardLabel, guards, guardStates, prices } = useMemo(() => {
        const guardLabel = props.label;
        console.log(candyMachineV3.prices)
        return {
            guardLabel,
            guards:
